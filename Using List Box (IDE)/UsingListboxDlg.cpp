...
BOOL UsingListboxDlg::Cls_OnInitDialog(HWND hwnd, HWND hwndFocus, LPARAM lParam)
{
    ...
    const TCHAR* items[] = { 
        TEXT("Милан Италия"), 
        TEXT("Ливерпуль Англия"), 
        TEXT("Бавария Германия"), 
        TEXT("Барселона Испания"),
        TEXT("Арсенал Англия"), 
        TEXT("Лион Франция"), 
        TEXT("Интер Италия"), 
        TEXT("Реал Испания") 
    ...
    const TCHAR* items2[] = { 
        TEXT("Рома Италия"), 
        TEXT("Манчестер Юнайтед Англия"), 
        TEXT("Вердер Германия"),
        TEXT("Валенсия Испания"),
        TEXT("Челси Англия"), 
        TEXT("Марсель Франция"), 
        TEXT("Ювентус Италия"), 
        TEXT("Атлетико Испания") 
    };
